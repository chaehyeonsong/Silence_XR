...
Shader "SoftKitty/PondingMobile"
{
	Properties
	{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			o.Albedo = ( ( pow( texCUBE( _ReflectionMap, ( ( ase_screenPosNorm * lerpResult236 ) + ( ( 1.0 - lerpResult236 ) * 0.05 ) ).xyz ) , 14.22 ) * float4( 0.6981132,0.6981132,0.6981132,1 ) ) + lerpResult197 ).rgb;
