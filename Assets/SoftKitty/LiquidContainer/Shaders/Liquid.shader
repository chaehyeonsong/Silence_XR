Shader "SoftKitty/Liquid"
{
	Properties
	{
	    ...
	    _WaveTile("WaveTile", Range(1 , 7)) = 1.5
		_EdgeLength ( "Edge length", Range( 2, 50 ) ) = 21.8
	...
	SubShader
	{
		...
		ENDCG
		CGPROGRAM
		#pragma surface surf BlinnPhong keepalpha fullforwardshadows vertex:vertexDataFunc tessellate:tessFunction 
